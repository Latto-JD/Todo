...
export function EntityForm({
  ...
  const [form, setForm] = useState(() => ({
    ...
    period_start: toDateInput(initial?.period_start),
    period_end: toDateInput(initial?.period_end),
...
const inputClass =
  "w-full rounded-md border border-zinc-300 px-2 py-1.5 text-sm text-zinc-900 focus:border-emerald-500 focus:outline-none";
